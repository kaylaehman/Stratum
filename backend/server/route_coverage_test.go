...
func TestNoUnauditedMutatingRoutes(t *testing.T) {
	...
	auditedMutating := map[string]bool{
		...
		"POST /api/volumes/prune-unused":                    true,
		...
		"POST /api/nodes/{id}/power/{action}":               true,
		...
		"POST /api/nodes/{id}/stacks/{project}/deploy":      true,
		"POST /api/nodes/{id}/stacks/{project}/lifecycle":   true,
		"PUT /api/nodes/{id}/stacks/{project}/env/{key}":    true,
		"DELETE /api/nodes/{id}/stacks/{project}/env/{key}": true,
		...
		"PUT /api/runbooks/{id}":                            true,
		"DELETE /api/runbooks/{id}":                         true,
		"POST /api/remediation":                             true,
		"POST /api/remediation/{id}/approve":                true,
		"POST /api/remediation/{id}/reject":                 true,
		"POST /api/remediation/{id}/execute":                true,
		"POST /api/skills":                                  true,
		"POST /api/skills/generate":                         true,
		"PUT /api/skills/{id}":                              true,
		"DELETE /api/skills/{id}":                           true,
